...
/**
 * TKL 88-key ISO layout (the ISO equivalent of TKL 87 ANSI).
 *
 * Differences from ANSI TKL 87 (same as Full ISO vs Full ANSI):
 *   - Enter is tall (L-shape) instead of wide
 *   - Left Shift is 1.25u + extra backslash key
 *   - Backslash moves to row 3 (above Enter)
 *   - Total: 88 keys (one more than ANSI 87)
 */
export const tkl88Iso: LayoutDef = {
  id: 'tkl87-iso',
  name: 'TKL 88 ISO',
  widthU: 18.5,
  heightU: 6,
  keys: [
    ...
    // ─── Row 2: TAB row (ISO: no backslash here) ───
    ...
    // ─── Row 3: CAPS row (ISO: extra # key + tall Enter) ───
    ...
    { id: 'K_BSISO',legend: '\\',  region: 'alpha',  x: 1.25, y: 4, w: 1, h: 1, sculptRow: 1 },
