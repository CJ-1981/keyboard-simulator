...
/**
 * 75% ISO compact 85-key layout.
 *
 * Same ISO differences as TKL ISO (tall Enter, extra # key, 1.25u L-SHIFT +
 * extra backslash), but in the packed 75% form factor.
 */
export const percent75Iso: LayoutDef = {
  id: 'percent75-iso',
  name: '75% ISO',
  widthU: 16,
  heightU: 6,
  keys: [
    // ─── Row 0: Packed function row ───
    ...
    // Row 2 ends at x=13.5 — no backslash key (moved to row 3 above Enter)
